...
<html lang="en">
    ...
    <?php include 'header.php' ?> 
        ...
        <div class="form-1">
            ...
            <h3 class="mt-5">select your skip size</h3>
            ...
            <h3>End date of hire</h3>
            <div class="mt-4 date">
                <div>
                    <input type="text" class="form-control btn-outline-dark end-date" placeholder="dd" aria-label="day" aria-describedby="basic-addon1">
                    <p class="date-slash">/</p>
                    <input type="text" class="form-control btn-outline-dark end-date" placeholder="mm" aria-label="day" aria-describedby="basic-addon1">
                    <p class="date-slash">/</p>
                    <input type="text" class="form-control btn-outline-dark end-date" placeholder="yyyy" aria-label="day" aria-describedby="basic-addon1">
                </div>
            </div>
        </div>
        <div class="form-2">
